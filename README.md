...
This system streamlines the entire homestay workflow, from customer inquiries to cleaner task assignments, replacing manual spreadsheet tracking with a centralized digital dashboard.
...
Architecture: RESTful API-driven architecture (Frontend fetches data from PHP API endpoints).

## 🚀 Installation & Setup
1. Clone the repository

git clone https://github.com/yourusername/charming-villa.git
cd charming-villa
...
Database name should be: charming_villa.
...
Visit http://localhost/charming-villa/admin/login.html to access the admin panel.
